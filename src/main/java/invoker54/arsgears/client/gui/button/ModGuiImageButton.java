...
@OnlyIn(Dist.CLIENT)
public class ModGuiImageButton extends Button
{
    ...
    public ModGuiImageButton( int x, int y,int u,int v,int w, int h, int image_width, int image_height, String resource_image, Button.IPressable onPress) {
    ...
    public ModGuiImageButton withTooltip(ModGuiSpellBook parent, TranslationTextComponent toolTip){
        this.parent = parent;
