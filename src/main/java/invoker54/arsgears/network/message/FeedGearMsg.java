...
public class FeedGearMsg {
    ...
    public FeedGearMsg(int newDamageValue, int[] foodArray, boolean isCombat){
    ...
    public static void encode(FeedGearMsg msg, PacketBuffer buffer){
        ...
        buffer.writeBoolean(msg.isCombat);
    }

    public static FeedGearMsg decode(PacketBuffer buffer){
        return new FeedGearMsg(buffer.readInt(), buffer.readVarIntArray(), buffer.readBoolean());
    }
    ...
    public static void handle(FeedGearMsg msg, Supplier<NetworkEvent.Context> contextSupplier){
        ...
        context.enqueueWork(() -> {
            ...
            ItemStack gearStack = (msg.isCombat ? playerCap.getCombatGear() : playerCap.getUtilityGear());
            ...
            gearStack.setDamageValue(msg.newDamageValue);
        });
